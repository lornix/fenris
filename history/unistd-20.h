// I keep this to see what is and what is not in 2.0 -- lcamtuf
...
#define __NR__exit __NR_exit
    inline _syscall0(int,idle)
    inline _syscall0(int,fork)
    inline _syscall2(int,clone,unsigned long,flags,char *,esp)
    ...
    inline _syscall3(off_t,lseek,int,fd,off_t,offset,int,count)
 ...
 */
inline pid_t kernel_thread(int (*fn)(void *), void * arg, unsigned long flags)
{
    long retval;
